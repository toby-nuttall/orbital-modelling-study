...
satalite = body(Solarsys, mass = 10, position = ( 100,0,0), velocity = (0,3,0))
#satalite.circular_velocity(Sun,(0,0,1))
#satalite2 = body(Solarsys, mass = 10, position = ( -200 , 0 , 0), velocity = (0,-2.236,0))
...
def animate(i):
    ...
    satalite.hoghman_transfer((0,0,1),300,100,Sun,i)
    

anim = animation.FuncAnimation( Solarsys.fig , animate ,frames =300 , interval =100)
writergif = animation.PillowWriter(fps = 50)
anim.save(r"C:\Users\tobyc\OneDrive\python\planets\hohmann_transfer.gif",writer = writergif)
plt.show()
